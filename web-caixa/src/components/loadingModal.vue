<template>
    <TransitionRoot
      ...
      <div
        class="rounded-2xl bg-main p-8 shadow-md flex justify-center flex-col items-center">
        <div class="w-24">
          <AppIconeSvg nome="RollingWhite" :tamanho="80" />
        </div>
        <div class="absolute left-32 bg-gray-100 animate-pulse-delay-1"></div>
