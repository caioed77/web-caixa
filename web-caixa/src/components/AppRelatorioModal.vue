                    ...
                    <TransitionChild as="template" enter="ease-out duration-300"
                        ...
                        <DialogPanel
                            ...
                            <div
                                ...
                                <div class="w-1/2 flex flex-col items-start gap-5 mb-5 mt-5">
                                    <AppDateBox label="Data inicial" v-model="dataInicial.toDateString" />
                                    <AppDateBox label="Data final" v-model="dataFinal.toDateString" />

                                    <div class="flex flex-col gap-2 w-full">
                                        <label class="font-bold">Tipo transação</label>
                                        <select
                                            class="bg-white w-full text-back border border-gray-300 rounded-lg p-2 focus:outline-none"
                                            id="tipo" v-model="tipoTransacao">
...
import { onGerarRelatorioTransacoes } from '../services/TransacoesService'
...
async function onGerarRelatorio() {
    ...
    if (dados !== undefined) {
        await onGerarRelatorioTransacoes(dados)
        onFecharModal();
    }    
}
</script>
