          ...
          >
            ...
            >
              ...
              >
                ...
                <h1 class="font-bold text-xl">Emissão de relatorio</h1>
                <div class="w-1/2 flex flex-col items-start gap-5 mb-5 mt-5">
                  <AppDateBox label="Data inicial" v-model="dataInicial" />
                  <AppDateBox label="Data final" v-model="dataFinal" />
                  ...
                  <button
                    type="button"
                    class="border w-full py-2 bg-red-800 text-white font-bold rounded-xl"
