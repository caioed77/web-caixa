            ...
            <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div
                    ...
                    <TransitionChild
                        ...
                        <DialogPanel
                            class="flex w-full transform text-left text-base transition md:my-8 max-w-xl">
                            <div
                                ...
                                <div class="flex flex-col gap-2 w-full">
                                    <label class="font-bold text-md"
                                        >Alterar quantidade moeda :
                                        {{ props.item.descricao }}</label
                                    >
                                    <input
                                        v-model="props.item.quantidade"
                                        class="border px-2 py-3 rounded-lg focus:outline-none" />
                                    <button
                                        type="button"
                                        class="border py-2 bg-red-800 hover:bg-red-700 text-white font-bold rounded-xl"
                                        @click="
                                            onAlterarMoeda(
                                                props.item.id,
