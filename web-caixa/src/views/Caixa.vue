<template>
  <header>
    ...
    <div class="pagina mx-auto rounded-xl px-10 mb-5 mt-5">
      ...
      <form @submit.prevent="onRealizarTransacao" class="p-5">
        ...
        <div class="flex w-full justify-between mt-2 bg-zinc-100 border border-zinc-300 p-5 rounded-md">
          <div class="w-2/5">
            ...
            <div class="flex flex-col border p-5 rounded-xl">
              ...
              />
              <div v-for="item in dadosMoedas" :key="item.id" class="grid grid-cols-3 mt-2">
                <div>{{ item.descricao }}</div>
                <div>{{ item.quantidade }}</div>
                <div class="flex w-full justify-end">
                  <button class="border rounded-full px-3 bg-red-800 text-white" @click="onAlterarQuantidadeMoeda(item)">
          ...
          <div class="w-1/2 px-5">
            ...
            <div class="flex justify-end items-start gap-3 mt-2">
              <button
                ...
                class="font-bold rounded-xl flex items-center justify-center gap-3 w-1/2 px-5 py-5 bg-red-800 text-white"
              >
...
import { onGravarTransacao, onRetornarTransacoes } from "../services/TransacoesService";
...
import { PhArrowsLeftRight, PhFloppyDisk, PhPaperPlaneRight } from "@phosphor-icons/vue";
