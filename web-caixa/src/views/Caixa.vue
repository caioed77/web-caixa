<template>
    <header>
        <div class="flex justify-center">
            <img
                src="../assets/FANS.png"
                class="h-32 object-center object-contain" />
        </div>
        ...
        <div class="pagina mx-auto rounded-xl px-10 mb-5 mt-5">
            ...
            <form class="p-5">
                <div class="flex justify-between w-full gap-10">
                    <div
                        class="flex flex-col w-full gap-3 bg-zinc-100 border border-zinc-300 p-3 rounded-md">
                        ...
                        <div class="w-1/2">
                            <select
                                class="bg-white w-full text-main border border-gray-300 rounded-lg p-2 focus:outline-none"
                                id="tipo"
                    ...
                    <div
                        class="w-full bg-zinc-100 border border-zinc-300 p-5 rounded-md">
                            ...
                            <div class="w-full mx-auto">
                                <div class="flex justify-between w-full">
                                    <AppPaginacao
                                        ...
                                        :ultima-pagina="
                                            dadosTransacao?.last ?? false
                                        "
                                        :primeira-pagina="
                                            dadosTransacao?.first ?? false
                                        "
                                        :total-paginas="
                                            dadosTransacao?.totalPages ?? 0
                                        "
                                        :total-registros="
                                            dadosTransacao?.totalElements ?? 0
                                        "
                                        @on-click-back="onPaginaMudou" />
                                    <div
                                        class="flex justify-between md:space-x-36">
                ...
                <div
                    class="flex w-full justify-between mt-2 bg-zinc-100 border border-zinc-300 p-5 rounded-md">
                    <div class="w-2/5">
                        <label for="valor" class="font-bold text-sm px-2"
                            >QUANTIDADE MOEDAS</label
                        >
                        <div class="flex flex-col border p-5 rounded-xl">
                            ...
                            <AppModalAlteracao
                                :abre-modal="exibirModalAlteracaoMoeda"
                                @on-close="onCloseModalMoeda"
                                :item="itemMoeda" />
                            <AppRelatorioModal
                                :abre-modal="exibirModalGerarRelatorio"
                                @on-close="onCloseModalRelatorio" />
                            <div
                                v-for="item in dadosMoedas"
                                :key="item.id"
                                ...
                                <div class="flex w-full justify-end">
                                    <button
                                        class="border rounded-full px-3 bg-red-800 hover:bg-red-700 text-white"
