<template>
    <header class="h-screen">
        ...
        <div class="pagina bg-zinc-200 border border-zinc-300 h-full mx-auto rounded-t-xl">
            <form @submit.prevent="onRealizarTransacao">
                <div class="flex justify-center items-center">
                    <div class="mx-auto text-xl border border-zinc-300 text-main bg-white px-5 py-5 rounded-xl">
                        <h2 class="font-bold">Saldo Caixa</h2>
                        <p class="text-center text-2xl">R$ {{ 20 }}</p>
                    </div>
                    <div class="mx-auto text-xl border border-zinc-300 text-main bg-white px-5 py-5 rounded-xl">
                ...
                <div class="flex justify-between w-full gap-10">
                    <div class="flex flex-col w-full gap-3 mt-10 bg-zinc-100 border border-zinc-300 p-5 rounded-md">
                        ...
                        <div class="w-1/2">
                            <input type="text"
                                ...
                                id="valor" v-model="dadosTransacaoGravar.valorTransacao" required />
                        </div>
                        ...
                        <div class="w-1/2">
                            <select
                                ...
                                id="tipo" v-model="dadosTransacaoGravar.tipoTransacao" required>
                        ...
                        <div class="flex justify-end">
                            <button @click="onRealizarTransacao"
                                class="flex font-bold p-5 bg-red-800 text-white hover:bg-red-700" type="submit">
                                Realizar Transação
                            </button>
                        </div>
                    </div>
                    <div class="flex flex-col w-full gap-3 mt-10 bg-zinc-100 border border-zinc-300 p-5 rounded-md">
                        ...
                        <div class="flex justify-end mt-8">
                            <button class="flex font-bold p-5 bg-red-800 text-white hover:bg-red-700" type="submit">
                                Alterar quantidade
                            </button>
                        </div>
                    </div>
...
const dadosTransacao = ref<ITransacoes[]>([])
